    ...
    <Layout>
      ...
      <section className="relative flex sm:flex-row flex-col w-[80vw] m-auto justify-between gap-2 mb-12">
        <article className='flex flex-col -mx-[8vw] sm:mx-0'>
          <h2 className="text-4xl leading-[70px] tracking-tight font-bold sm:mx-0 mx-[8vw]">Une entreprise en faveur de l&apos;humain.</h2>
        ...
        <div className='relative sm:w-2/3 w-full sm:min-w-[400px] min-h-[400px]'>
          <Image 
          priority
